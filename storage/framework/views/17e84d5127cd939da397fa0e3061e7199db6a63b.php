            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="card-box">
                        ...
                        <form action="<?php echo e(url('/admin/data-petugas/update',$id)); ?>" method="POST" oninput="re_type_password.setCustomValidity(re_type_password.value != password.value ? 'Passwords do not match.' : '')">
                            <?php echo csrf_field(); ?>
                            <?php echo method_field('PUT'); ?>
                            <div class="form-group row">
                                <label class="col-4 col-form-label">Nama Petugas</label>
                                <div class="col-7">
                                    <input type="text" name="nama_petugas" class="form-control" placeholder="Isi Nama Petugas" required="required" value="<?php echo e(old('nama_petugas') != '' ? old('nama_petugas') : $row->nama_petugas); ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-7">
                                    <select name="jabatan_petugas" class="form-control select2">
                                        ...
                                        <option value="bendahara-internal" <?php if(old('jabatan_petugas') != ''): ?>
                                            <?php echo old('jabatan_petugas') == 'bendahara-internal' ? 'selected="selected"' : ''; ?>

                                            <?php else: ?>
                                            <?php echo $row->jabatan_petugas == 'bendahara-internal' ? 'selected="selected"' : ''; ?>

                                            <?php endif; ?>>Bendahara Internal</option>
                                        <option value="bendahara-dana-BOS" <?php if(old('jabatan_petugas') != ''): ?>
                                            <?php echo old('jabatan_petugas') == 'bendahara-dana-BOS' ? 'selected="selected"' : ''; ?>

                                            <?php else: ?>
                                            <?php echo $row->jabatan_petugas == 'bendahara-dana-BOS' ? 'selected="selected"' : ''; ?>

                                            <?php endif; ?>>Bendahara Dana BOS</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group row">
...
<?php $__env->stopSection(); ?> 
<?php echo $__env->make('Admin.layout-app.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/web_keuangan/resources/views/Admin/petugas/petugas-edit.blade.php ENDPATH**/ ?>