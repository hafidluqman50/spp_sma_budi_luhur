            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="card-box">
                        ...
                        <?php endif; ?>
                        <table class="table table-hover table-bordered data-rincian-pembelanjaan-kepsek force-fullwidth" id-rincian-pengeluaran="<?php echo e($id); ?>" ket-data="operasional">
                            <thead>
                            <tr>
                                <th>No.</th>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('Kepsek.layout-app.layout-rab', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/web_keuangan/resources/views/Kepsek/rincian-pembelanjaan/main.blade.php ENDPATH**/ ?>