                    ...
                    <div class="card-box">
                        ...
                        <form action="<?php echo e(url('/admin/data-users/save')); ?>" method="POST" oninput="re_type_password.setCustomValidity(re_type_password.value != password.value ? 'Passwords do not match.' : '')">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-7">
                                    <input type="text" name="nama_users" class="form-control" placeholder="Isi Nama Users" required="required" value="<?php echo e(old('nama_users') != '' ? old('nama_users') : ''); ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-7">
                                    <select name="jenis_users" class="form-control select2">
                                        ...
                                        <option value="2" <?php if(old('jenis_users') != ''): ?>
                                            <?php echo old('jenis_users') == 2 ? 'selected="selected"' : ''; ?><?php endif; ?>>Petugas SPP</option>
                                        <option value="1" <?php if(old('jenis_users') != ''): ?>
                                            <?php echo old('jenis_users') == 1 ? 'selected="selected"' : ''; ?><?php endif; ?>>Kepsek</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group row">
...
<?php echo $__env->make('Admin.layout-app.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/web_keuangan/resources/views/Admin/data-users/data-users-tambah.blade.php ENDPATH**/ ?>