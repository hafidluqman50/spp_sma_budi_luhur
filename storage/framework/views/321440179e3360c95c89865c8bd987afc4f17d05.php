                        ...
                        <table class="table table-hover table-bordered datatable force-fullwidth" id-spp="<?php echo e($id); ?>">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>    
                                        <div class="d-flex">
                                            <a href="<?php echo e(url("/petugas/spp/tunggakan/$id/lihat-pemasukan-kantin/$element->id_spp_bulan_tahun")); ?>" style="margin-right:1%;">
                                              <button class="btn btn-success"> Lihat Pemasukan Kantin </button>
                                           </a>
                                            <a href="<?php echo e(url("/petugas/spp/tunggakan/$id/lihat-spp/$element->id_spp_bulan_tahun")); ?>" style="margin-right:1%;">
                                              <button class="btn btn-info"> Lihat SPP </button>
                                           </a>
                                            <a href="<?php echo e(url("/petugas/spp/tunggakan/$id/edit/$element->id_spp_bulan_tahun")); ?>" style="margin-right:1%;">
