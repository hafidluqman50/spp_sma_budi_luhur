                ...
                <div class="col-12">
                    <div class="card-box table-responsive">
                        ...
                        <div class="button-list" style="margin-bottom:1%;">
                            <a href="<?php echo e(url('/petugas/spp/tunggakan/'.$id)); ?>">
                                <button class="btn btn-default">
                                    <i class="fa fa-arrow-left"></i> Kembali
                                </button>
                            </a>
                            <a href="<?php echo e(url('/petugas/spp/tunggakan/'.$id.'/lihat-spp/'.$id_bulan_tahun.'/bayar-semua')); ?>">
...
<?php echo $__env->make('Petugas.layout-app.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/web_keuangan/resources/views/Petugas/spp-detail/main.blade.php ENDPATH**/ ?>