            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="card-box">
                        ...
                        <?php endif; ?>
                        <table class="table table-hover table-bordered data-rincian-penerimaan-tahun-ajaran force-fullwidth" id-rincian-penerimaan="<?php echo e($id_rincian_penerimaan); ?>">
                            <thead>
                            <tr>
                                <th>No.</th>
                                <th>Bulan, Tahun</th>
...
<?php echo $__env->make('Admin.layout-app.layout-rab', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/web_keuangan/resources/views/Admin/rincian-penerimaan/rincian-tahun-ajaran.blade.php ENDPATH**/ ?>