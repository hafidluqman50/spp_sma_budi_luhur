<?php $__env->startSection('content'); ?>
    <div class="wrapper">
        <div class="container">
            ...
            <form id="form-spp-bayar" action="<?php echo e(url('/petugas/spp/bulan-tahun/'.$id.'/lihat-spp/'.$id_bulan_tahun.'/bayar-semua/save')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <div class="row">
                            ...
                            <div id="layout-bayar-spp">
                                <div id="bayar-spp">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-7">
                                            <input type="number" name="bayar_spp[]" class="form-control bayar-spp" placeholder="Isi Jumlah Bayar" id-kolom-spp="<?php echo e($value->id_kolom_spp); ?>" bayar-spp-attr="<?php echo e($key+1); ?>">
...
<?php echo $__env->make('Petugas.layout-app.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/web_keuangan/resources/views/Petugas/spp-detail/spp-detail-bayar-semua.blade.php ENDPATH**/ ?>