...
<script>
    ...
    $(document).on('click','.info-siswa',function(){
        ...
        let url          = `${base_url}/kepsek/laporan-data-siswa/lihat-data?kelas=${attr}&id_tahun_ajaran=${tahun_ajaran}`
...
<?php echo $__env->make('Kepsek.layout-app.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/web_keuangan/resources/views/Kepsek/laporan/laporan-data-siswa.blade.php ENDPATH**/ ?>