                        ...
                        <ul class="list-inline float-right mb-0">
                            ...
                            <li class="list-inline-item dropdown notification-list">
                                ...
                                <div class="dropdown-menu dropdown-menu-right profile-dropdown " aria-labelledby="Preview">
                                    <!-- item-->
                                    <a href="<?php echo e(url('/petugas/settings')); ?>" class="dropdown-item notify-item">
                    ...
                    <div id="navigation">
                        ...
                        <ul class="navigation-menu">
                            ...
                            <li class="has-submenu">
                                <a href="<?php echo e(url('/petugas/dashboard')); ?>"><i class="md md-dashboard"></i>Dashboard</a>
                            </li>

                            <li class="has-submenu">
                                <a href="#"><i class="md md-account-circle"></i>Data Siswa</a>
                                <ul class="submenu">
                                    <li><a href="<?php echo e(url('/petugas/siswa')); ?>">Data Siswa</a></li>
                                    <li><a href="<?php echo e(url('/petugas/kelas')); ?>">Data Kelas</a></li>
                                    <li><a href="<?php echo e(url('/petugas/tahun-ajaran')); ?>">Data Tahun Ajaran</a></li>
                                </ul>
                            </li>

                            <li class="has-submenu">
                                <a href="<?php echo e(url('/petugas/kantin')); ?>"><i class="fa fa-pencil-square-o"></i>Data Kantin</a>
                            </li>

                            <li class="has-submenu">
                                <a href="#"><i class="fa fa-money"></i>Data SPP</a>
                                <ul class="submenu">
                                    <li><a href="<?php echo e(url('/petugas/spp')); ?>">Data SPP</a></li>
                                    <li><a href="<?php echo e(url('/petugas/kolom-spp')); ?>">Data Kolom SPP</a></li>
                            ...
                            <li class="has-submenu">
                                ...
                                <ul class="submenu">
                                    <li>
                                        <a href="<?php echo e(url('/petugas/laporan-data-siswa')); ?>">Laporan Data Siswa</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo e(url('/petugas/laporan-kantin')); ?>">Laporan Kantin</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo e(url('/petugas/laporan-tunggakan')); ?>">Laporan Tunggakan</a>
                                        
                                    </li>
                                    <li>
                                        <a href="<?php echo e(url('/petugas/laporan-pembukuan')); ?>">Laporan Pembukuan</a>
                                    </li>
                            ...
                            <li class="has-submenu">
                                <a href="<?php echo e(url('/petugas/data-perincian-rab')); ?>"><i class="fa fa-book"></i>Data RAB</a>
                            </li>
                        </ul>
                        <!-- End navigation menu -->
                    </div> <!-- end #navigation -->
...
<?php /**PATH /var/www/web_keuangan/resources/views/Petugas/layout-app/header.blade.php ENDPATH**/ ?>