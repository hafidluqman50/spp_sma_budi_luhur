                        ...
                        <ul class="list-inline float-right mb-0">
                            ...
                            <li class="list-inline-item dropdown notification-list">
                                ...
                                <div class="dropdown-menu dropdown-menu-right dropdown-arrow dropdown-lg" aria-labelledby="Preview">
                                    ...
                                    <a href="<?php echo e(url('/petugas/spp/history-spp/'.$element->id_history_proses_spp)); ?>" class="dropdown-item notify-item">
                                    ...
                                    <!-- All-->
                                    <a href="<?php echo e(url('/petugas/spp/history-spp')); ?>" class="dropdown-item notify-item notify-all">
                                        View All
                                    </a>
