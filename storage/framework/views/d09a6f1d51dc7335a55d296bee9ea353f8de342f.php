                    ...
                    <div class="page-title-box">
                        <div class="btn-group pull-right">
                            <ol class="breadcrumb hide-phone p-0 m-0">
                                ...
                                <li class="breadcrumb-item active"><a href="<?php echo e(url('/kepsek/data-perincian-rab')); ?>">Sapras</a></li>
                            </ol>
                        </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="card-box">
                        ...
                        <table class="table table-hover table-bordered data-sapras-kepsek force-fullwidth" id-rincian-pengeluaran="<?php echo e($id); ?>">
                            <thead>
                            <tr>
                                <th>No.</th>
                                <th>Kategori</th>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('Kepsek.layout-app.layout-rab', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/web_keuangan/resources/views/Kepsek/sapras/main.blade.php ENDPATH**/ ?>