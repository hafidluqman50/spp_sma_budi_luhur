            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="card-box">
                        ...
                        <form action="<?php echo e(url('/petugas/kolom-spp/update',$id)); ?>" method="POST">
...
<?php echo $__env->make('Petugas.layout-app.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/web_keuangan/resources/views/Petugas/kolom-spp/kolom-spp-edit.blade.php ENDPATH**/ ?>