            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="card-box">
                        ...
                        <form action="<?php echo e(url('/admin/tahun-ajaran/save')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('Admin.layout-app.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\web_keuangan\resources\views/Admin/tahun-ajaran/tahun-ajaran-tambah.blade.php ENDPATH**/ ?>