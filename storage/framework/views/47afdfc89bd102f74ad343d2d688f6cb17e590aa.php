                    ...
                    <div class="card-box">
                        ...
                        <div class="form-group row">
                            <div class="col-8 offset-4">
                                <a href="<?php echo e(url('/petugas/spp/contoh-import')); ?>" class="text-danger">Silahkan Download Format Excel Disini!</a>
                            </div>
                        </div>
                        ...
                        <form method="POST" action="<?php echo e(url('/petugas/spp/kantin/import/save')); ?>" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <div class="form-group row">
                        ...
                        <form method="POST" action="<?php echo e(url('/petugas/spp/import/save')); ?>" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <div class="form-group row">
                                <label class="col-4 col-form-label">File<span class="text-danger">*</span></label>
                                <div class="col-7">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('Petugas.layout-app.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/web_keuangan/resources/views/Petugas/spp/spp-import.blade.php ENDPATH**/ ?>