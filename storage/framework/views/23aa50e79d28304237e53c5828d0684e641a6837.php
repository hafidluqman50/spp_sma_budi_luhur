                    ...
                    <div class="card-box">
                        ...
                        <form action="<?php echo e(url('/admin/data-petugas/save')); ?>" method="POST" oninput="re_type_password.setCustomValidity(re_type_password.value != password.value ? 'Passwords do not match.' : '')">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-7">
                                    <input type="text" name="nama_petugas" class="form-control" placeholder="Isi Nama Petugas" required="required" value="<?php echo e(old('nama_petugas') != '' ? old('nama_petugas') : ''); ?>">
                                </div>
                            </div>
                            <div class="form-group row">
