        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card-box">
                    ...
                    <table class="table table-hover table-bordered data-pemasukan-kantin force-fullwidth" id-spp-bulan-tahun="<?php echo e($id_bulan_tahun); ?>">
                        <thead>
                            <tr>
                                <th>No.</th>
                                <th>Nama Kantin</th>
...
<?php echo $__env->make('Admin.layout-app.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/web_keuangan__/resources/views/Admin/pemasukan-kantin/main.blade.php ENDPATH**/ ?>