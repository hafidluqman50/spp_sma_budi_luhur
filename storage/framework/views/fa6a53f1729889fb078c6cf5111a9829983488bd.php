                ...
                <div class="col-12">
                    <div class="card-box table-responsive">
                        ...
                        <div class="button-list" style="margin-bottom:1%;">
                            <a href="<?php echo e(url('/admin/kelas/tambah')); ?>">
                                <button class="btn btn-primary">
                                    <i class="fa fa-plus m-r-5"></i>Tambah
                                </button>
                            </a>
                            <a href="<?php echo e(url('/admin/kelas/naik-kelas')); ?>">
...
<?php echo $__env->make('Admin.layout-app.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/web_keuangan__/resources/views/Admin/kelas/main.blade.php ENDPATH**/ ?>