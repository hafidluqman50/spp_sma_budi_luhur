<?php $__env->startSection('content'); ?>
    <div class="wrapper">
        <div class="container">
            ...
            <form action="<?php echo e(url('/petugas/spp/save')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <div class="row">
...
<?php echo $__env->make('Petugas.layout-app.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/web_keuangan/resources/views/Petugas/spp/spp-tambah.blade.php ENDPATH**/ ?>