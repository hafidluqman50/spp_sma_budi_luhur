                    ...
                    <div class="page-title-box">
                        <div class="btn-group pull-right">
                            <ol class="breadcrumb hide-phone p-0 m-0">
                                ...
                                <li class="breadcrumb-item active"><a href="<?php echo e(url('/kepsek/data-perincian-rab')); ?>">Rincian Penerimaan</a></li>
                            </ol>
                        </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="card-box">
                        ...
                        <?php endif; ?>
                        <table class="table table-hover table-bordered data-rincian-penerimaan-detail-kepsek force-fullwidth" id-rincian-pengeluaran="<?php echo e($id); ?>">
                            <thead>
                            <tr>
                                <th>No.</th>
                                <th>Perincian</th>
                ...
                <div class="col-sm-12">
                    <div class="card-box">
                        ...
                        <table class="table table-hover table-bordered data-rincian-penerimaan-rekap-kepsek force-fullwidth" id-rincian-pengeluaran="<?php echo e($id); ?>">
                            <thead>
                            <tr>
                ...
                <div class="col-sm-12">
                    <div class="card-box">
                        ...
                        <table class="table table-hover table-bordered data-rincian-penerimaan-tahun-ajaran-kepsek force-fullwidth" id-rincian-pengeluaran="<?php echo e($id); ?>">
                            <thead>
                            <tr>
                                <th>No.</th>
                                <th>Bulan, Tahun</th>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('Kepsek.layout-app.layout-rab', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/web_keuangan/resources/views/Kepsek/rincian-penerimaan/main.blade.php ENDPATH**/ ?>