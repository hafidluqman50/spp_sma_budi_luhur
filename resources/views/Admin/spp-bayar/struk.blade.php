        ...
        <div class="col-lg-12">
            <table>
                ...
                <tr>
                    <td>Uang Sejumlah</td>
                    <td>:</td>
                    <td>{{ format_rupiah($spp_detail_row->total_biaya) }}</td>
                </tr>
                <tr>
                ...
                <tr>
                    <td>Terbilang Rp.</td>
                    <td>:</td>
                    <td>{{ ucwords(terbilang($spp_detail_row->total_biaya)) }}</td>
                </tr>
            </table>
            <p class="text-right">Samarinda, {{ human_date($spp_detail_row->tanggal_bayar) }}</p>
