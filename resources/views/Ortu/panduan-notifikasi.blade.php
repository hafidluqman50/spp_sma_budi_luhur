                    ...
                    <div class="page-title-box">
                        <div class="btn-group pull-right">
                            <ol class="breadcrumb hide-phone p-0 m-0">
                                ...
                                <li class="breadcrumb-item active"><a href="{{ url('/admin/data-perincian-rab') }}">Panduan Notifikasi</a></li>
                            </ol>
                        </div>
                    ...
                    <div class="card-box">
                        ...
                        <ol>
                            <li>
                                ...
                                <img src="{{ asset('assets/panduan_notifikasi_1.png') }}" style="margin-top:2%;width: 100%;height: auto;" alt="">
                            </li>
                            <br>
                            <hr>
                            <li>
                                Klik Tulisan /start Pada Bot Telegram Ini
                                <img src="{{ asset('assets/panduan_notifikasi_2.png') }}" style="margin-top:2%;width: 100%;height: auto;" alt="">
                            </li>
                            <br>
                            <hr>
                            <li>
                                Masukkan Nomor Telepon Orang Tua yang telah terdata di sistem SPP !
                                <img src="{{ asset('assets/panduan_notifikasi_3.png') }}" style="margin-top:2%;width: 100%;height: auto;" alt="">
                            </li>
                            <br>
                            <hr>
                            <li>
                                ...
                                <img src="{{ asset('assets/panduan_notifikasi_4.png') }}" style="margin-top:2%;width: 100%;height: auto;" alt="">
                            </li>
                            <br>
                            <hr>
                            <li>
                                ...
                                <img src="{{ asset('assets/panduan_notifikasi_5.png') }}" style="margin-top:2%;width: 100%;height: auto;" alt="">
                            </li>
                            <br>
                            <hr>
                            <li>
                                ...
                                <img src="{{ asset('assets/panduan_notifikasi_6.png') }}" style="margin-top:2%;width: 100%;height: auto;" alt="">
                            </li>
                            <br>
                            <hr>
                            <li>
                                ...
                                <img src="{{ asset('assets/panduan_notifikasi_7.png') }}" style="margin-top:2%;width: 100%;height: auto;" alt="">
                            </li>
                            <br>
                            <hr>
                            <li>
                                ...
                                <img src="{{ asset('assets/panduan_notifikasi_8.png') }}" style="margin-top:2%;width: 100%;height: auto;" alt="">
                            </li>
                            <br>
                            <hr>
                            <li>
                                ...
                                <img src="{{ asset('assets/panduan_notifikasi_9.png') }}" style="margin-top:2%;width: 100%;height: auto;" alt="">
                            </li>
                        </ol>
                    </div>
                </div>
