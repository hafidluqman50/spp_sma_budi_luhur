                ...
                <div class="col-sm-12">
                    <div class="card-box">
                        ...
                        <div class="button-list" style="margin-bottom:1%;">
                            ...
                            <a href="{{ url('/petugas/data-perincian-rab/rincian-pembelanjaan-uang-makan/'.$id.'/tambah') }}">
                                <button class="btn btn-primary" style="cursor:pointer;">
                                    <i class="fa fa-plus m-r-5"></i>Tambah
                                </button>
                            </a>
                            <a href="{{ url('/petugas/data-perincian-rab/rincian-pembelanjaan-uang-makan/'.$id.'/edit') }}">
