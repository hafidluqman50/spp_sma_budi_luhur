                    ...
                    <div class="page-title-box">
                        <div class="btn-group pull-right">
                            <ol class="breadcrumb hide-phone p-0 m-0">
                                ...
                                <li class="breadcrumb-item active"><a href="{{ url('/petugas/data-perincian-rab') }}">Rincian Penerimaan</a></li>
                            </ol>
                        </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="card-box">
                        ...
                        <div class="button-list" style="margin-bottom:1%;">
                            ...
                            <a href="{{ url('/petugas/data-perincian-rab/rincian-penerimaan/'.$id.'/tambah') }}">
                                <button class="btn btn-primary" style="cursor:pointer;">
                                    Tambah
                                </button>
                            </a>
                            <a href="{{ url('/petugas/data-perincian-rab/rincian-penerimaan/'.$id.'/edit') }}">
                        ...
                        @endif
                        <table class="table table-hover table-bordered data-rincian-penerimaan-detail force-fullwidth" id-rincian-pengeluaran="{{$id}}">
                            <thead>
                            <tr>
                                <th>No.</th>
                                <th>Perincian</th>
                ...
                <div class="col-sm-12">
                    <div class="card-box">
                        ...
                        <table class="table table-hover table-bordered data-rincian-penerimaan-rekap force-fullwidth" id-rincian-pengeluaran="{{$id}}">
                            <thead>
                            <tr>
                ...
                <div class="col-sm-12">
                    <div class="card-box">
                        ...
                        <table class="table table-hover table-bordered data-rincian-penerimaan-tahun-ajaran force-fullwidth" id-rincian-pengeluaran="{{$id}}">
                            <thead>
                            <tr>
                                <th>No.</th>
                                <th>Bulan, Tahun</th>
