                ...
                <div class="col-12">
                    <div class="card-box table-responsive">
                        ...
                        <div class="button-list" style="margin-bottom:1%;">
                            <a href="{{ url('/petugas/spp/pembayaran/'.$id) }}">
                        ...
                        <table class="table table-hover table-bordered datatable force-fullwidth" id-bulan-tahun="{{$id_spp_bayar_data}}">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>    
                                        <div class="d-flex">
                                            <a href="{{url("/petugas/spp/pembayaran/$id/lihat-pembayaran/$element->id_spp_bayar_data/detail/$element->id_spp_bayar")}}" style="margin-right:1%;">
