            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="card-box">
                        ...
                        <form action="{{ url('/petugas/kelas/siswa/'.$id.'/update/'.$id_detail) }}" method="POST">
                            @method('PUT')
                            @csrf
                            <div class="form-group row">
                                ...
                                <div class="col-7">
                                    <select name="siswa" class="form-control select2" required="required">
                                        ...
                                        <option value="{{ $element->id_siswa }}" {!!$row->id_siswa == $element->id_siswa ? 'selected="selected"' : ''!!}>{{ $element->nisn.' | '.$element->nama_siswa }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-7">
                                    <select name="tahun_ajaran" class="form-control select2" required="required">
                                        ...
                                        <option value="{{ $element->id_tahun_ajaran }}" {!!$row->id_tahun_ajaran == $element->id_tahun_ajaran ? 'selected="selected"' : ''!!}>{{ $element->tahun_ajaran }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
