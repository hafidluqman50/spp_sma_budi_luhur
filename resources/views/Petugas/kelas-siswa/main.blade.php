                    ...
                    <div class="page-title-box">
                        <div class="btn-group pull-right">
                            <ol class="breadcrumb hide-phone p-0 m-0">
                                ...
                                <li class="breadcrumb-item active"><a href="{{ url('/petugas/kelas-siswa') }}">Data Kelas Siswa</a></li>
                            </ol>
                        </div>
                ...
                <div class="col-sm-12">
                    <div class="card-box">
                        ...
                        <div class="button-list" style="margin-bottom:1%;">
                            <a href="{{ url('/petugas/kelas/siswa/'.$id.'/tambah') }}">
                        ...
                        @endif
                        <table class="table table-hover table-bordered data-kelas-siswa force-fullwidth" id-kelas="{{$id}}">
                            <thead>
                            <tr>
                                <th>No.</th>
                                <th>NISN</th>
