                    ...
                    <div id="navigation">
                        ...
                        <ul class="navigation-menu">
                            ...
                            <li class="has-submenu">
                                <a href="{{ url('/kepsek/dashboard') }}"><i class="md md-dashboard"></i>Dashboard</a>
                            </li>

                            <li class="has-submenu">
                                <a href="#"><i class="md md-account-circle"></i>Data Siswa</a>
                                <ul class="submenu">
                                    <li><a href="{{ url('/kepsek/siswa') }}">Data Siswa</a></li>
                                    <li><a href="{{ url('/kepsek/kelas') }}">Data Kelas</a></li>
                                    <li><a href="{{ url('/kepsek/tahun-ajaran') }}">Data Tahun Ajaran</a></li>
                                </ul>
                            </li>

                            <li class="has-submenu">
                                <a href="{{ url('/kepsek/kantin') }}"><i class="fa fa-pencil-square-o"></i>Data Kantin</a>
                            </li>

                            <li class="has-submenu">
                                <a href="#"><i class="fa fa-money"></i>Data SPP</a>
                                <ul class="submenu">
                                    <li><a href="{{ url('/kepsek/spp') }}">Data SPP</a></li>
                                    <li><a href="{{ url('/kepsek/kolom-spp') }}">Data Kolom SPP</a></li>
                                    {{-- <li><a href="{{ url('/kepsek/tunggakan-spp') }}">Data Tunggakan SPP</a></li> --}}
                                </ul>
                            </li>
                            ...
                            <li class="has-submenu">
                                ...
                                <ul class="submenu">
                                    <li>
                                        <a href="{{ url('/kepsek/laporan-data-siswa') }}">Laporan Data Siswa</a>
                                    </li>
                                    <li>
                                        <a href="{{ url('/kepsek/laporan-kantin') }}">Laporan Kantin</a>
                                    </li>
                                    <li>
