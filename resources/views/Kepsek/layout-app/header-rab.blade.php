                    ...
                    <div id="navigation">
                        ...
                        <ul class="navigation-menu">
                            ...
                            <li class="has-submenu">
                                <a href="{{ url('/kepsek/dashboard') }}"><i class="md md-arrow-back"></i>Dashboard</a>
                            </li>

                            {{-- <li class="has-submenu">
                                <a href="{{ url('/kepsek/kategori-rab') }}"><i class="fa fa-pencil-square-o"></i>Kategori RAB</a>
                            </li>

                            <li class="has-submenu">
                                <a href="{{ url('/kepsek/barang-rab') }}"><i class="fa fa-users"></i>Barang RAB</a>
                            </li> --}}

                            <li class="has-submenu">
                                <a href="{{ url('/kepsek/data-perincian-rab') }}"><i class="fa fa-database"></i>Data Perincian</a>
                            </li>
                        </ul>
                        <!-- End navigation menu -->
                    </div> <!-- end #navigation -->
