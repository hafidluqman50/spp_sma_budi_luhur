...
<script>
    $(() => {
        ...
        $('.info-tunggakan').click(function() {
            ...
            let url = `${base_url}/kepsek/laporan-tunggakan/lihat-data?kelas_siswa_input=${attr}&tahun_ajaran=${tahun_ajaran}&tahun_awal=${tahun_awal}&tahun_akhir=${tahun_akhir}&bulan_awal=${bulan_awal}&bulan_akhir=${bulan_akhir}`
