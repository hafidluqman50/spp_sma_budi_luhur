            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="card-box">
                        ...
                        @endif
                        <form action="{{ url('/kepsek/settings/save') }}" method="POST" oninput="re_type_password.setCustomValidity(re_type_password.value != password.value ? 'Passwords do not match.' : '')">
                            @csrf
