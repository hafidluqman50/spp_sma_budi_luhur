                    ...
                    <div class="page-title-box">
                        <div class="btn-group pull-right">
                            <ol class="breadcrumb hide-phone p-0 m-0">
                                ...
                                <li class="breadcrumb-item active"><a href="{{ url('/kepsek/rincian-pengeluaran') }}">Rincian Pengeluaran</a></li>
                            </ol>
                        </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="card-box">
                        ...
                        <table class="table table-hover table-bordered data-rincian-pengeluaran-sekolah-kepsek force-fullwidth" id-rincian-pengeluaran="{{ $id }}">
                            <thead>
                            <tr>
                                <th>No.</th>
                ...
                <div class="col-sm-12">
                    <div class="card-box">
                        ...
                        <table class="table table-hover table-bordered data-rincian-pengeluaran-uang-makan-kepsek force-fullwidth" id-rincian-pengeluaran="{{ $id }}">
                            <thead>
                            <tr>
                                <th>No.</th>
                                <th>Tanggal Uraian</th>
