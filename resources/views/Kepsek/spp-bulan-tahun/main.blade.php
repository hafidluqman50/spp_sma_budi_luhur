                        ...
                        <table class="table table-hover table-bordered datatable force-fullwidth" id-spp="{{$id}}">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>    
                                        <div class="d-flex">
                                            <a href="{{url("/kepsek/spp/tunggakan/$id/lihat-pemasukan-kantin/$element->id_spp_bulan_tahun")}}" style="margin-right:1%;">
                                              <button class="btn btn-success"> Lihat Pemasukan Kantin </button>
                                           </a>
                                            <a href="{{url("/kepsek/spp/tunggakan/$id/lihat-spp/$element->id_spp_bulan_tahun")}}" style="margin-right:1%;">
