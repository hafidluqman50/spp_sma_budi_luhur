...
class RincianPenerimaanController extends Controller
{
    ...
    public function edit($id)
    {
        ...
        return view('Admin.rincian-penerimaan.rincian-penerimaan-edit',compact('title','id','pendapatan','tahun_ajaran','bulan_laporan','bulan','bon_pengajuan','realisasi_pengeluaran','row','row_penerimaan_rekap','row_penerimaan_tahun_ajaran'));
    }
