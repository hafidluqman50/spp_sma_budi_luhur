...
class RincianPembelanjaanController extends Controller
{
    ...
    public function editRincianPembelanjaanUangMakan($id)
    {
        ...
        return view('Admin.rincian-pembelanjaan.rincian-pembelanjaan-uang-makan-edit',compact('title','kategori_group','id','rincian_pembelanjaan','rincian_pengeluaran_detail','tanggal_setor_dapur','tahun_ajaran','bulan_laporan','bulan','rincian_tahun_ajaran'));
    }
