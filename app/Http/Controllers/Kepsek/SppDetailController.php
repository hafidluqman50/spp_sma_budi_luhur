...
class SppDetailController extends Controller
{
    ...
    {
        $title = 'Form Bayar | Kepsek';
        $spp   = SppDetail::getBayarById($id_detail);

        return view('Kepsek.spp-detail.spp-detail-bayar',compact('title','id','id_bulan_tahun','id_detail','spp'));
    }
    ...
    public function bayar(Request $request,$id,$id_bulan_tahun,$id_detail)
    {
        ...
        // return redirect('/kepsek/spp/bulan-tahun/'.$id.'/lihat-spp/'.$id_bulan_tahun)->with('message','Berhasil Bayar SPP');
        return view('Kepsek.spp-detail.struk',compact('total_biaya','spp_detail_row','tanggal_bayar','id','id_bulan_tahun','petugas'));
    }

    public function formBayarSemua($id,$id_bulan_tahun)
    {
        $title = 'Form Bayar Semua | Kepsek';
        ...
        return view('Kepsek.spp-detail.spp-detail-bayar-semua',compact('title','id','id_bulan_tahun','total_semua','spp','spp_bayar'));
    }
    ...
    public function delete($id,$id_bulan_tahun,$id_detail)
    {
        ...
        return redirect('/kepsek/spp/bulan-tahun/'.$id.'/lihat-spp/'.$id_bulan_tahun)->with('message','Berhasil Hapus Data');
    }
    ...
    {  
        ...
        return redirect('/kepsek/spp/bulan-tahun/'.$id.'/lihat-pembayaran/'.$id_bulan_tahun)->with('message','Berhasil Delete Pembayaran SPP');
    }
    ...
    public function lihatPembayaranDetailDelete($id,$id_bulan_tahun,$id_bayar,$id_detail)
    {
        ...
        return redirect('/kepsek/spp/bulan-tahun/'.$id.'/lihat-pembayaran/'.$id_bulan_tahun.'/detail/'.$id_bayar)->with('message','Berhasil Delete SPP Bayar Detail');
    }
}
