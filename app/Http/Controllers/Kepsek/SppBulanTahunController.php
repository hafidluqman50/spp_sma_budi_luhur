...
class SppBulanTahunController extends Controller
{
    ...
    public function edit($id,$id_bulan_tahun)
    {
        ...
        return view('Kepsek.spp-bulan-tahun.spp-bulan-tahun-edit',compact('title','id','id_bulan_tahun','row','row_kolom_spp','kolom_spp'));
    }
    ...
    public function update(Request $request,$id,$id_bulan_tahun)
    {
        ...
        return redirect('/kepsek/spp/bulan-tahun/'.$id.'/lihat-spp/'.$id_bulan_tahun)->with('message','Berhasil Edit SPP');
    }
    ...
    public function delete($id,$id_bulan_tahun)
    {
        ...
        return redirect('/kepsek/spp/bulan-tahun/'.$id)->with('message','Berhasil Hapus Data');
    }
}
