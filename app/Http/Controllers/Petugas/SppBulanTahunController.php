...
class SppBulanTahunController extends Controller
{
    public function index($id)
    {
        ...
        return view('Petugas.spp-bulan-tahun.main',compact('title','id','siswa','spp_bulan_tahun','tahun','spp_detail'));
    }
    ...
    public function edit($id,$id_bulan_tahun)
    {
        ...
        return view('Petugas.spp-bulan-tahun.spp-bulan-tahun-edit',compact('title','id','id_bulan_tahun','row','row_kolom_spp','kolom_spp','kantin'));
    }
    ...
    public function update(Request $request,$id,$id_bulan_tahun)
    {
        ...
        return redirect('/petugas/spp/tunggakan/'.$id.'/lihat-spp/'.$id_bulan_tahun)->with('message','Berhasil Edit SPP');
    }
    ...
    public function delete($id,$id_bulan_tahun)
    {
        ...
        return redirect('/petugas/spp/tunggakan/'.$id)->with('message','Berhasil Hapus Data');
    }

    public function lihatPemasukanKantin($id,$id_bulan_tahun)
    {
        $title = 'Lihat Pemasukan Kantin | Petugas';
        ...
        return view('Petugas.pemasukan-kantin.main',compact('title','id','id_bulan_tahun','data_spp'));
    }
}
