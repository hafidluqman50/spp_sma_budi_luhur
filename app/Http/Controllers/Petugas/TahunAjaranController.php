...
class TahunAjaranController extends Controller
{
    ...
    {
        $title = 'TahunAjaran | Petugas';

        return view('Petugas.tahun-ajaran.main',compact('title'));
    }

    public function tambah()
    {
        $title = 'Form TahunAjaran | Petugas';

        return view('Petugas.tahun-ajaran.tahun-ajaran-tambah',compact('title'));
    }
    ...
    {
        $title = 'Form Tahun Ajaran | Petugas';
        $row   = TahunAjaran::where('id_tahun_ajaran',$id)->firstOrFail();

        return view('Petugas.tahun-ajaran.tahun-ajaran-edit',compact('title','row','id'));
    }
