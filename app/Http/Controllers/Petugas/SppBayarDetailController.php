...
class SppBayarDetailController extends Controller
{
    public function index($id,$id_spp_bayar_data,$id_spp_bayar)
    {
        ...
        return view('Petugas.spp-bayar.detail',compact('title','id','id_spp_bayar_data','id_spp_bayar','siswa'));
    }
    ...
    public function delete($id,$id_spp_bayar_data,$id_spp_bayar,$id_spp_bayar_detail)
    {
        ...
        return redirect('/petugas/spp/pembayaran/'.$id.'/lihat-pembayaran/'.$id_spp_bayar_data.'/detail/'.$id_spp_bayar)->with('message','Berhasil Menghapus Data');
    }
}
