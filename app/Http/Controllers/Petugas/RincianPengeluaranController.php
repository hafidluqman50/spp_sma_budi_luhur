...
class RincianPengeluaranController extends Controller
{
    ...
    {
        $title = 'Petugas | Rincian Pengeluaran';
        return view('Petugas.rincian-pengeluaran.main',compact('title'));
    }

    public function tambah()
    {
        $title        = 'Petugas | Form Rincian Pengeluaran';
        ...
        return view('Petugas.rincian-pengeluaran.rincian-pengeluaran-tambah',compact('title','kolom_spp','tahun_ajaran','kantin'));
    }
    ...
    public function edit($id)
    {
        ...
        $row_sekolah    = RincianPengeluaranSekolah::where('id_rincian_pengeluaran',$id)->get();
        $row_uang_makan = RincianPengeluaranUangMakan::where('id_rincian_pengeluaran',$id)->get();

        return view('Petugas.rincian-pengeluaran.rincian-pengeluaran-edit',compact('title','kolom_spp','tahun_ajaran','row','row_sekolah','id','row_uang_makan','kantin'));
    }
    ...
    {   
        ...
        $ket_rincian_pengeluaran_sekolah = $request->keterangan_rincian;
        ...
        for ($i=0; $i < count($uraian_rincian); $i++) {
            ...
            $data_rincian_pengeluaran_sekolah = [
                ...
                'ket_rincian_pengeluaran_sekolah' => $ket_rincian_pengeluaran_sekolah[$i]
            ];
        ...
        return redirect('/petugas/data-perincian-rab')->with('message','Berhasil Input RAB');
    }
    ...
    public function update(Request $request,$id)
    {
        ...
        $id_rincian_pengeluaran_sekolah    = $request->id_rincian_pengeluaran_sekolah;
        $id_rincian_pengeluaran_uang_makan = $request->id_rincian_pengeluaran_uang_makan;
        ...
        for ($i=0; $i < count($uraian_rincian); $i++) {
            ...
            if ($id_rincian_pengeluaran_sekolah[$i] != '') {
                $data_rincian_pengeluaran_sekolah = [
                    'tanggal_rincian'        => $tanggal_perincian[$i],
                    'uraian_rincian'         => $uraian_rincian[$i],
                    'volume_rincian'         => $volume_rincian[$i],
                ...
                RincianPengeluaranSekolah::where('id_rincian_pengeluaran_sekolah',$id_rincian_pengeluaran_sekolah[$i])->update($data_rincian_pengeluaran_sekolah);
            }
            else {
                $data_rincian_pengeluaran_sekolah = [
                ...
                RincianPengeluaranDetail::create($data_rincian_pengeluaran_sekolah);
            }
        }

        for ($j=0; $j < count($uraian_rincian_uang_makan); $j++) {
            if ($id_rincian_pengeluaran_uang_makan[$j] != '') {
                $data_rincian_pengeluaran_uang_makan = [
                    'tanggal_rincian'        => $tanggal_perincian_uang_makan[$j],
                    'uraian_rincian'         => $uraian_rincian_uang_makan[$j],
                    'volume_rincian'         => $volume_rincian_uang_makan[$j],
                ...
                RincianPengeluaranUangMakan::where('id_rincian_pengeluaran_uang_makan',$id_rincian_pengeluaran_uang_makan[$j])->update($data_rincian_pengeluaran_uang_makan); 
            } 
            else {
                $data_rincian_pengeluaran_uang_makan = [
                    'id_rincian_pengeluaran' => $id,
        ...
        return redirect('/petugas/data-perincian-rab')->with('message','Berhasil Update RAB');
    }
    ...
    public function delete($id)
    {
        ...
        return redirect('/petugas/data-perincian-rab')->with('message','Berhasil Hapus RAB');
    }
    ...
    public function lihatRincianPengeluaranSekolah($id)
    {
        ...
        return view('Petugas.rincian-pengeluaran.rincian-pengeluaran-sekolah',compact('title','id'));
    }
    ...
    public function lihatRincianPengeluaranUangMakan($id)
    {
        ...
        return view('Petugas.rincian-pengeluaran.rincian-pengeluaran-uang-makan',compact('title','id'));
    }
    ...
    public function deleteRincianPengeluaranSekolah($id,$id_detail)
    {
        ...
        return redirect('/petugas/data-perincian-rab/rincian-pengeluaran-sekolah/'.$id)->with('message','Berhasil Hapus Data');
    }
    ...
    public function deleteRincianPengeluaranUangMakan($id,$id_detail)
    {
        ...
        return redirect('/petugas/data-perincian-rab/rincian-pengeluaran-uang-makan/'.$id)->with('message','Berhasil Hapus Data');
    }
}
