...
class KelasController extends Controller
{
    public function index()
    {
        ...
        return view('Petugas.kelas.main',compact('title'));
    }

    public function tambah()
    {
        $title = 'Form Kelas | Petugas';

        return view('Petugas.kelas.kelas-tambah',compact('title'));
    }
    ...
    public function save(Request $request)
    {
        ...
        return redirect('/petugas/kelas')->with('message','Berhasil Input Kelas');
    }
    ...
    public function edit($id)
    {
        ...
        return view('Petugas.kelas.kelas-edit',compact('title','row','id'));
    }
    ...
    public function update(Request $request,$id)
    {
        ...
        return redirect('/petugas/kelas')->with('message','Berhasil Update Kelas');
    }
    ...
    public function delete($id)
    {
        ...
        return redirect('/petugas/kelas')->with('message','Berhasil Delete Kelas');
    }

    public function naikKelasForm()
    {
        $title        = 'Petugas | Naik Kelas Form';
        $kelas        = Kelas::where('status_delete',0)->get();
        $tahun_ajaran = TahunAjaran::where('status_delete',0)->get();

        return view('Petugas.kelas.naik-kelas',compact('title','kelas','tahun_ajaran'));
    }
    ...
    public function naikKelasSave(Request $request)
    {
        ...
        return redirect('/petugas/kelas')->with('message','Berhasil Naik Kelas');
    }
}
