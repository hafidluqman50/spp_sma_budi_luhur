...
class SppController extends Controller
{
                            ...
                            if ($num > 1) {
                                ...
                                if ($cells[1]->getValue() != '' && $cells[2]->getValue() != '' && $cells[3]->getValue() != '' && $cells[4]->getValue() != '') {
                                    ...
                                    if ($check_kelas_siswa == 'true') {
                                        ...
                                        return redirect('/petugas/spp/import')->with('log','Siswa " '.$cells[2]->getValue().' " pada sheet SPP tidak ditemukan di data kelas! Mohon periksa kembali!');
                                    }
                                }
                                else {
    ...
    public function kalkulasiUlang()
    {
        ...
        return redirect('/petugas/spp')->with('message','Berhasil Update Total Harus Bayar');
    }
