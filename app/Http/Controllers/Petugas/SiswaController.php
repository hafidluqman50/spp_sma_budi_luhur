...
class SiswaController extends Controller
{
    ...
    {
        $title = 'Data Siswa | Petugas';

        return view('Petugas.siswa.main',compact('title'));
    }

    public function tambah()
    {
        $title          = 'Form Siswa | Petugas';
        $keluarga       = Siswa::where('status_delete',0)->get();
        $keluarga_check = new Keluarga;

        return view('Petugas.siswa.siswa-tambah',compact('title','keluarga','keluarga_check'));
    }
    ...
    public function save(Request $request)
    {
        ...
        return redirect('/petugas/siswa')->with('message','Berhasil Input Siswa');
    }
    ...
    public function edit($id)
    {
        ...
        return view('Petugas.siswa.siswa-edit',compact('title','row','keluarga','keluarga_check','id'));
    }
    ...
    {   
        ...
        // if ($id == $keluarga) {
        //     return redirect('/petugas/siswa/edit/'.$id)->withInput();
        // }
        ...
        return redirect('/petugas/siswa')->with('message','Berhasil Update Siswa');
    }
    ...
    public function delete($id)
    {
        ...
        return redirect('/petugas/siswa')->with('message','Berhasil Delete Siswa');
    }
    ...
    public function formImport()
    {
        ...
        return view('Petugas.siswa.siswa-import',compact('title'));
    }
    ...
    public function import(Request $request)
    {
            ...
            if ($sheet->getIndex() === 0) {
                foreach ($sheet->getRowIterator() as $num => $row) {
                    if ($num > 1) {
                        ...
                        if ($check_kelas == 0) {
                            return redirect('/petugas/siswa/import')->with('log','Kelas '.$cells[11]->getValue().' tidak ditemukan! mohon cek kembali data kelas');
                        }
                        else {
                        ...
                        if ($check_tahun_ajaran == 0) {
                            return redirect('/petugas/siswa/import')->with('log','Tahun Ajaran '.$cells[12]->getValue().' tidak ditemukan! mohon cek kembali data tahun ajaran');
                        }
                        else {
                ...
                foreach ($sheet->getRowIterator() as $num => $row) {
                    if ($num > 1) {
                        ...
                        if ($cells[1]->getValue() != '' && $cells[2]->getValue() != '') {
                            ...
                            // dd($check_siswa);
                            if ($check_siswa == 0) {
                                return redirect('petugas/siswa/import/')->with('log','Siswa '.$cells[2]->getValue().' tidak ditemukan di sheet Data Keluarga! mohon cek kembali data siswa');
                            }
                            else {
        ...
        return redirect('/petugas/siswa')->with('message','Berhasil Import Siswa');
    }
}
