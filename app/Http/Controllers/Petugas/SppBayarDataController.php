...
class SppBayarDataController extends Controller
{
    public function index($id)
    {
        ...
        return view('Petugas.spp-bayar.main',compact('title','id','siswa'));
    }
    ...
    public function delete($id,$id_spp_bayar_data)
    {
        ...
        return redirect('/petugas/spp/pembayaran/'.$id)->with('message','Berhasil Menghapus Data');
    }
    ...
    public function cetakStruk($id,$id_spp_bayar_data)
    {
        ...
        return view('Petugas.spp-bayar.struk',compact('id','id_spp_bayar_data','spp_bayar','untuk_pembayaran','profile_instansi'));
    }
    ...
    public function returBayar($id,$id_spp_bayar_data)
    {
        ...
        return redirect('/petugas/spp/pembayaran/'.$id)->with('message','Berhasil Retur Bayar');
    }
}
